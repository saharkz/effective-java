...
public class ItemSixTest {
    ...
    public Long getRunTimeBadSolution(Integer times, String romanNum) {
    ...
    @Test
    public void goodWithBadSolutionTest() {


        final String ROMAN_NUMBER_EXAMPLE = "MCMXXXIV";
        Integer times = 10000;

        final Long timeTakesBad = getRunTimeBadSolution(times, ROMAN_NUMBER_EXAMPLE);
        ...
        System.out.println("Bad solution time: " + timeTakesBad + " nano second");
        System.out.println("Good solution time: " + timeTakesGood + " nano second");
